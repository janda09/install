...
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="JandaBaper"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=JandaBaper|' /etc/openvpn/easy-rsa/vars
